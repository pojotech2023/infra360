...
import 'package:raptor_pro/view/subcontractor/subcontractor_dashboard/subcontractor_payment/subcontractor_payment_controller.dart';import 'package:raptor_pro/view/widgets/common_app_bar.dart';
import 'package:raptor_pro/view/widgets/common_button.dart';
import 'package:raptor_pro/view/widgets/common_loader.dart';


class AddSubContractorPaymentScreen extends StatefulWidget{
  @override
  State<AddSubContractorPaymentScreen> createState() => _AddSubContractorPaymentScreenState();
}

class _AddSubContractorPaymentScreenState extends State<AddSubContractorPaymentScreen> {

  AddSubContractorPaymentController controller = Get.put(AddSubContractorPaymentController());
                ...
                children: [
                  ...
                  CommonButton(onTap: () {
                    if(_formKey.currentState!.validate()){
                      ...
                      controller.addSubContractorPayment();
