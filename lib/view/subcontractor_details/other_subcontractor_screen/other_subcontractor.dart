...
import 'other_subcontractor_view.dart';
import 'others_subcontractor_controller.dart';

class OtherSubcontractorScreen extends StatefulWidget{
  @override
  State<OtherSubcontractorScreen> createState() => _OtherSubcontractorScreenState();
}

class _OtherSubcontractorScreenState extends State<OtherSubcontractorScreen> {

  var controller = Get.put(OthersSubcontractorController());
  File? attachment;
  int ?siteId;
        ...
        child: Column(
          ...
          children: [
            ...
            Obx((){
              return
                ...
                CommonButton(onTap: (){
                  ...
                  controller.otherSave(siteId!,attachment!);
            ...
            CommonButton(
                ...
                onTap: (){
                  Get.to(OtherSubcontractorView(),arguments: siteId!);
